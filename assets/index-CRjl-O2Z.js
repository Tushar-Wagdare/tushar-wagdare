 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(L,W){var K=L.length;L.push(W);e:for(;0<K;){var oe=K-1>>>1,Se=L[oe];if(0<r(Se,W))L[oe]=W,L[K]=Se,K=oe;else break e}}function n(L){return L.length===0?null:L[0]}function i(L){if(L.length===0)return null;var W=L[0],K=L.pop();if(K!==W){L[0]=K;e:for(var oe=0,Se=L.length,qe=Se>>>1;oe<qe;){var G=2*(oe+1)-1,ne=L[G],pe=G+1,se=L[pe];if(0>r(ne,K))pe<Se&&0>r(se,ne)?(L[oe]=se,L[pe]=K,oe=pe):(L[oe]=ne,L[G]=K,oe=G);else if(pe<Se&&0>r(se,K))L[oe]=se,L[pe]=K,oe=pe;else break e}}return W}function r(L,W){var K=L.sortIndex-W.sortIndex;return K!==0?K:L.id-W.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,d=null,f=3,p=!1,_=!1,y=!1,g=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(L){for(var W=n(u);W!==null;){if(W.callback===null)i(u);else if(W.startTime<=L)i(u),W.sortIndex=W.expirationTime,e(l,W);else break;W=n(u)}}function x(L){if(y=!1,v(L),!_)if(n(l)!==null)_=!0,X(P);else{var W=n(u);W!==null&&j(x,W.startTime-L)}}function P(L,W){_=!1,y&&(y=!1,h(C),C=-1),p=!0;var K=f;try{for(v(W),d=n(l);d!==null&&(!(d.expirationTime>W)||L&&!b());){var oe=d.callback;if(typeof oe=="function"){d.callback=null,f=d.priorityLevel;var Se=oe(d.expirationTime<=W);W=t.unstable_now(),typeof Se=="function"?d.callback=Se:d===n(l)&&i(l),v(W)}else i(l);d=n(l)}if(d!==null)var qe=!0;else{var G=n(u);G!==null&&j(x,G.startTime-W),qe=!1}return qe}finally{d=null,f=K,p=!1}}var A=!1,w=null,C=-1,T=5,S=-1;function b(){return!(t.unstable_now()-S<T)}function z(){if(w!==null){var L=t.unstable_now();S=L;var W=!0;try{W=w(!0,L)}finally{W?V():(A=!1,w=null)}}else A=!1}var V;if(typeof m=="function")V=function(){m(z)};else if(typeof MessageChannel<"u"){var q=new MessageChannel,J=q.port2;q.port1.onmessage=z,V=function(){J.postMessage(null)}}else V=function(){g(z,0)};function X(L){w=L,A||(A=!0,V())}function j(L,W){C=g(function(){L(t.unstable_now())},W)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(L){L.callback=null},t.unstable_continueExecution=function(){_||p||(_=!0,X(P))},t.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<L?Math.floor(1e3/L):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(L){switch(f){case 1:case 2:case 3:var W=3;break;default:W=f}var K=f;f=W;try{return L()}finally{f=K}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(L,W){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var K=f;f=L;try{return W()}finally{f=K}},t.unstable_scheduleCallback=function(L,W,K){var oe=t.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?oe+K:oe):K=oe,L){case 1:var Se=-1;break;case 2:Se=250;break;case 5:Se=1073741823;break;case 4:Se=1e4;break;default:Se=5e3}return Se=K+Se,L={id:c++,callback:W,priorityLevel:L,startTime:K,expirationTime:Se,sortIndex:-1},K>oe?(L.sortIndex=K,e(u,L),n(l)===null&&L===n(u)&&(y?(h(C),C=-1):y=!0,j(x,K-oe))):(L.sortIndex=Se,e(l,L),_||p||(_=!0,X(P))),L},t.unstable_shouldYield=b,t.unstable_wrapCallback=function(L){var W=f;return function(){var K=f;f=W;try{return L.apply(this,arguments)}finally{f=K}}}})(W0);G0.exports=W0;var EM=G0.exports;/**
 * @license React
...
}`;function jD(t,e,n){let i=new qp;const r=new We,s=new We,o=new yt,a=new zD({depthPacking:OR}),l=new HD,u={},c=n.maxTextureSize,d={[gr]:ln,[ln]:gr,[yi]:yi},f=new vr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new We},radius:{value:4}},vertexShader:GD,fragmentShader:WD}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const _=new Oi;_.setAttribute("position",new li(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new Ln(_,f),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=_S;let h=this.type;this.render=function(A,w,C){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||A.length===0)return;const T=t.getRenderTarget(),S=t.getActiveCubeFace(),b=t.getActiveMipmapLevel(),z=t.state;z.setBlending(ur),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const V=h!==gi&&this.type===gi,q=h===gi&&this.type!==gi;for(let J=0,X=A.length;J<X;J++){const j=A[J],L=j.shadow;if(L===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;r.copy(L.mapSize);const W=L.getFrameExtents();if(r.multiply(W),s.copy(L.mapSize),(r.x>c||r.y>c)&&(r.x>c&&(s.x=Math.floor(c/W.x),r.x=s.x*W.x,L.mapSize.x=s.x),r.y>c&&(s.y=Math.floor(c/W.y),r.y=s.y*W.y,L.mapSize.y=s.y)),L.map===null||V===!0||q===!0){const oe=this.type!==gi?{minFilter:qn,magFilter:qn}:{};L.map!==null&&L.map.dispose(),L.map=new es(r.x,r.y,oe),L.map.texture.name=j.name+".shadowMap",L.camera.updateProjectionMatrix()}t.setRenderTarget(L.map),t.clear();const K=L.getViewportCount();for(let oe=0;oe<K;oe++){const Se=L.getViewport(oe);o.set(s.x*Se.x,s.y*Se.y,s.x*Se.z,s.y*Se.w),z.viewport(o),L.updateMatrices(j,oe),i=L.getFrustum(),x(w,C,L.camera,j,this.type)}L.isPointLightShadow!==!0&&this.type===gi&&m(L,C),L.needsUpdate=!1}h=this.type,g.needsUpdate=!1,t.setRenderTarget(T,S,b)};function m(A,w){const C=e.update(y);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new es(r.x,r.y)),f.uniforms.shadow_pass.value=A.map.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,t.setRenderTarget(A.mapPass),t.clear(),t.renderBufferDirect(w,null,C,f,y,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,t.setRenderTarget(A.map),t.clear(),t.renderBufferDirect(w,null,C,p,y,null)}function v(A,w,C,T){let S=null;const b=C.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(b!==void 0)S=b;else if(S=C.isPointLight===!0?l:a,t.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const z=S.uuid,V=w.uuid;let q=u[z];q===void 0&&(q={},u[z]=q);let J=q[V];J===void 0&&(J=S.clone(),q[V]=J,w.addEventListener("dispose",P)),S=J}if(S.visible=w.visible,S.wireframe=w.wireframe,T===gi?S.side=w.shadowSide!==null?w.shadowSide:w.side:S.side=w.shadowSide!==null?w.shadowSide:d[w.side],S.alphaMap=w.alphaMap,S.alphaTest=w.alphaTest,S.map=w.map,S.clipShadows=w.clipShadows,S.clippingPlanes=w.clippingPlanes,S.clipIntersection=w.clipIntersection,S.displacementMap=w.displacementMap,S.displacementScale=w.displacementScale,S.displacementBias=w.displacementBias,S.wireframeLinewidth=w.wireframeLinewidth,S.linewidth=w.linewidth,C.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const z=t.properties.get(S);z.light=C}return S}function x(A,w,C,T,S){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&S===gi)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,A.matrixWorld);const V=e.update(A),q=A.material;if(Array.isArray(q)){const J=V.groups;for(let X=0,j=J.length;X<j;X++){const L=J[X],W=q[L.materialIndex];if(W&&W.visible){const K=v(A,W,T,S);A.onBeforeShadow(t,A,w,C,V,K,L),t.renderBufferDirect(C,null,V,K,A,L),A.onAfterShadow(t,A,w,C,V,K,L)}}}else if(q.visible){const J=v(A,q,T,S);A.onBeforeShadow(t,A,w,C,V,J,null),t.renderBufferDirect(C,null,V,J,A,null),A.onAfterShadow(t,A,w,C,V,J,null)}}const z=A.children;for(let V=0,q=z.length;V<q;V++)x(z[V],w,C,T,S)}function P(A){A.target.removeEventListener("dispose",P);for(const C in u){const T=u[C],S=A.target.uuid;S in T&&(T[S].dispose(),delete T[S])}}}const XD={[Pd]:bd,[Ld]:Nd,[Dd]:Ud,[ro]:Id,[bd]:Pd,[Nd]:Ld,[Ud]:Dd,[Id]:ro};function YD(t,e){function n(){let D=!1;const le=new yt;let H=null;const Q=new yt(0,0,0,0);return{setMask:function(de){H!==de&&!D&&(t.colorMask(de,de,de,de),H=de)},setLocked:function(de){D=de},setClear:function(de,ce,Ie,vt,Ot){Ot===!0&&(de*=vt,ce*=vt,Ie*=vt),le.set(de,ce,Ie,vt),Q.equals(le)===!1&&(t.clearColor(de,ce,Ie,vt),Q.copy(le))},reset:function(){D=!1,H=null,Q.set(-1,0,0,0)}}}function i(){let D=!1,le=!1,H=null,Q=null,de=null;return{setReversed:function(ce){if(le!==ce){const Ie=e.get("EXT_clip_control");le?Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.ZERO_TO_ONE_EXT):Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.NEGATIVE_ONE_TO_ONE_EXT);const vt=de;de=null,this.setClear(vt)}le=ce},getReversed:function(){return le},setTest:function(ce){ce?se(t.DEPTH_TEST):Pe(t.DEPTH_TEST)},setMask:function(ce){H!==ce&&!D&&(t.depthMask(ce),H=ce)},setFunc:function(ce){if(le&&(ce=XD[ce]),Q!==ce){switch(ce){case Pd:t.depthFunc(t.NEVER);break;case bd:t.depthFunc(t.ALWAYS);break;case Ld:t.depthFunc(t.LESS);break;case ro:t.depthFunc(t.LEQUAL);break;case Dd:t.depthFunc(t.EQUAL);break;case Id:t.depthFunc(t.GEQUAL);break;case Nd:t.depthFunc(t.GREATER);break;case Ud:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}Q=ce}},setLocked:function(ce){D=ce},setClear:function(ce){de!==ce&&(le&&(ce=1-ce),t.clearDepth(ce),de=ce)},reset:function(){D=!1,H=null,Q=null,de=null,le=!1}}}function r(){let D=!1,le=null,H=null,Q=null,de=null,ce=null,Ie=null,vt=null,Ot=null;return{setTest:function(Je){D||(Je?se(t.STENCIL_TEST):Pe(t.STENCIL_TEST))},setMask:function(Je){le!==Je&&!D&&(t.stencilMask(Je),le=Je)},setFunc:function(Je,Un,ui){(H!==Je||Q!==Un||de!==ui)&&(t.stencilFunc(Je,Un,ui),H=Je,Q=Un,de=ui)},setOp:function(Je,Un,ui){(ce!==Je||Ie!==Un||vt!==ui)&&(t.stencilOp(Je,Un,ui),ce=Je,Ie=Un,vt=ui)},setLocked:function(Je){D=Je},setClear:function(Je){Ot!==Je&&(t.clearStencil(Je),Ot=Je)},reset:function(){D=!1,le=null,H=null,Q=null,de=null,ce=null,Ie=null,vt=null,Ot=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,u=new WeakMap;let c={},d={},f=new WeakMap,p=[],_=null,y=!1,g=null,h=null,m=null,v=null,x=null,P=null,A=null,w=new Ge(0,0,0),C=0,T=!1,S=null,b=null,z=null,V=null,q=null;const J=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,j=0;const L=t.getParameter(t.VERSION);L.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(L)[1]),X=j>=1):L.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(L)[1]),X=j>=2);let W=null,K={};const oe=t.getParameter(t.SCISSOR_BOX),Se=t.getParameter(t.VIEWPORT),qe=new yt().fromArray(oe),G=new yt().fromArray(Se);function ne(D,le,H,Q){const de=new Uint8Array(4),ce=t.createTexture();t.bindTexture(D,ce),t.texParameteri(D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(D,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ie=0;Ie<H;Ie++)D===t.TEXTURE_3D||D===t.TEXTURE_2D_ARRAY?t.texImage3D(le,0,t.RGBA,1,1,Q,0,t.RGBA,t.UNSIGNED_BYTE,de):t.texImage2D(le+Ie,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,de);return ce}const pe={};pe[t.TEXTURE_2D]=ne(t.TEXTURE_2D,t.TEXTURE_2D,1),pe[t.TEXTURE_CUBE_MAP]=ne(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),pe[t.TEXTURE_2D_ARRAY]=ne(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),pe[t.TEXTURE_3D]=ne(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),se(t.DEPTH_TEST),o.setFunc(ro),Ve(!1),ze(bv),se(t.CULL_FACE),U(ur);function se(D){c[D]!==!0&&(t.enable(D),c[D]=!0)}function Pe(D){c[D]!==!1&&(t.disable(D),c[D]=!1)}function De(D,le){return d[D]!==le?(t.bindFramebuffer(D,le),d[D]=le,D===t.DRAW_FRAMEBUFFER&&(d[t.FRAMEBUFFER]=le),D===t.FRAMEBUFFER&&(d[t.DRAW_FRAMEBUFFER]=le),!0):!1}function ke(D,le){let H=p,Q=!1;if(D){H=f.get(le),H===void 0&&(H=[],f.set(le,H));const de=D.textures;if(H.length!==de.length||H[0]!==t.COLOR_ATTACHMENT0){for(let ce=0,Ie=de.length;ce<Ie;ce++)H[ce]=t.COLOR_ATTACHMENT0+ce;H.length=de.length,Q=!0}}else H[0]!==t.BACK&&(H[0]=t.BACK,Q=!0);Q&&t.drawBuffers(H)}function dt(D){return _!==D?(t.useProgram(D),_=D,!0):!1}const je={[Or]:t.FUNC_ADD,[uR]:t.FUNC_SUBTRACT,[cR]:t.FUNC_REVERSE_SUBTRACT};je[fR]=t.MIN,je[dR]=t.MAX;const St={[hR]:t.ZERO,[pR]:t.ONE,[mR]:t.SRC_COLOR,[Cd]:t.SRC_ALPHA,[SR]:t.SRC_ALPHA_SATURATE,[yR]:t.DST_COLOR,[vR]:t.DST_ALPHA,[gR]:t.ONE_MINUS_SRC_COLOR,[Rd]:t.ONE_MINUS_SRC_ALPHA,[xR]:t.ONE_MINUS_DST_COLOR,[_R]:t.ONE_MINUS_DST_ALPHA,[MR]:t.CONSTANT_COLOR,[ER]:t.ONE_MINUS_CONSTANT_COLOR,[TR]:t.CONSTANT_ALPHA,[wR]:t.ONE_MINUS_CONSTANT_ALPHA};function U(D,le,H,Q,de,ce,Ie,vt,Ot,Je){if(D===ur){y===!0&&(Pe(t.BLEND),y=!1);return}if(y===!1&&(se(t.BLEND),y=!0),D!==lR){if(D!==g||Je!==T){if((h!==Or||x!==Or)&&(t.blendEquation(t.FUNC_ADD),h=Or,x=Or),Je)switch(D){case js:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Lv:t.blendFunc(t.ONE,t.ONE);break;case Dv:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Iv:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case js:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Lv:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case Dv:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Iv:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}m=null,v=null,P=null,A=null,w.set(0,0,0),C=0,g=D,T=Je}return}de=de||le,ce=ce||H,Ie=Ie||Q,(le!==h||de!==x)&&(t.blendEquationSeparate(je[le],je[de]),h=le,x=de),(H!==m||Q!==v||ce!==P||Ie!==A)&&(t.blendFuncSeparate(St[H],St[Q],St[ce],St[Ie]),m=H,v=Q,P=ce,A=Ie),(vt.equals(w)===!1||Ot!==C)&&(t.blendColor(vt.r,vt.g,vt.b,Ot),w.copy(vt),C=Ot),g=D,T=!1}function Sn(D,le){D.side===yi?Pe(t.CULL_FACE):se(t.CULL_FACE);let H=D.side===ln;le&&(H=!H),Ve(H),D.blending===js&&D.transparent===!1?U(ur):U(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),o.setFunc(D.depthFunc),o.setTest(D.depthTest),o.setMask(D.depthWrite),s.setMask(D.colorWrite);const Q=D.stencilWrite;a.setTest(Q),Q&&(a.setMask(D.stencilWriteMask),a.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),a.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),ot(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?se(t.SAMPLE_ALPHA_TO_COVERAGE):Pe(t.SAMPLE_ALPHA_TO_COVERAGE)}function Ve(D){S!==D&&(D?t.frontFace(t.CW):t.frontFace(t.CCW),S=D)}function ze(D){D!==sR?(se(t.CULL_FACE),D!==b&&(D===bv?t.cullFace(t.BACK):D===oR?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Pe(t.CULL_FACE),b=D}function Ce(D){D!==z&&(X&&t.lineWidth(D),z=D)}function ot(D,le,H){D?(se(t.POLYGON_OFFSET_FILL),(V!==le||q!==H)&&(t.polygonOffset(le,H),V=le,q=H)):Pe(t.POLYGON_OFFSET_FILL)}function we(D){D?se(t.SCISSOR_TEST):Pe(t.SCISSOR_TEST)}function R(D){D===void 0&&(D=t.TEXTURE0+J-1),W!==D&&(t.activeTexture(D),W=D)}function M(D,le,H){H===void 0&&(W===null?H=t.TEXTURE0+J-1:H=W);let Q=K[H];Q===void 0&&(Q={type:void 0,texture:void 0},K[H]=Q),(Q.type!==D||Q.texture!==le)&&(W!==H&&(t.activeTexture(H),W=H),t.bindTexture(D,le||pe[D]),Q.type=D,Q.texture=le)}function O(){const D=K[W];D!==void 0&&D.type!==void 0&&(t.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function Z(){try{t.compressedTexImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ee(){try{t.compressedTexImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Y(){try{t.texSubImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Me(){try{t.texSubImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ue(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function me(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Xe(){try{t.texStorage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ie(){try{t.texStorage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ge(){try{t.texImage2D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Re(){try{t.texImage3D.apply(t,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function be(D){qe.equals(D)===!1&&(t.scissor(D.x,D.y,D.z,D.w),qe.copy(D))}function ve(D){G.equals(D)===!1&&(t.viewport(D.x,D.y,D.z,D.w),G.copy(D))}function He(D,le){let H=u.get(le);H===void 0&&(H=new WeakMap,u.set(le,H));let Q=H.get(D);Q===void 0&&(Q=t.getUniformBlockIndex(le,D.name),H.set(D,Q))}function Fe(D,le){const Q=u.get(le).get(D);l.get(le)!==Q&&(t.uniformBlockBinding(le,Q,D.__bindingPointIndex),l.set(le,Q))}function it(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),c={},W=null,K={},d={},f=new WeakMap,p=[],_=null,y=!1,g=null,h=null,m=null,v=null,x=null,P=null,A=null,w=new Ge(0,0,0),C=0,T=!1,S=null,b=null,z=null,V=null,q=null,qe.set(0,0,t.canvas.width,t.canvas.height),G.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:se,disable:Pe,bindFramebuffer:De,drawBuffers:ke,useProgram:dt,setBlending:U,setMaterial:Sn,setFlipSided:Ve,setCullFace:ze,setLineWidth:Ce,setPolygonOffset:ot,setScissorTest:we,activeTexture:R,bindTexture:M,unbindTexture:O,compressedTexImage2D:Z,compressedTexImage3D:ee,texImage2D:ge,texImage3D:Re,updateUBOMapping:He,uniformBlockBinding:Fe,texStorage2D:Xe,texStorage3D:ie,texSubImage2D:Y,texSubImage3D:Me,compressedTexSubImage2D:ue,compressedTexSubImage3D:me,scissor:be,viewport:ve,reset:it}}function C0(t,e,n,i){const r=$D(i);switch(n){case ES:return t*e;case wS:return t*e;case AS:return t*e*2;case CS:return t*e/r.components*r.byteLength;case Wp:return t*e/r.components*r.byteLength;case RS:return t*e*2/r.components*r.byteLength;case jp:return t*e*2/r.components*r.byteLength;case TS:return t*e*3/r.components*r.byteLength;case Xn:return t*e*4/r.components*r.byteLength;case Xp:return t*e*4/r.components*r.byteLength;case Gl:case Wl:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case jl:case Xl:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case zd:case Gd:return Math.max(t,16)*Math.max(e,8)/4;case Vd:case Hd:return Math.max(t,8)*Math.max(e,8)/2;case Wd:case jd:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case Xd:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Yd:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case $d:return Math.floor((t+4)/5)*Math.floor((e+3)/4)*16;case qd:return Math.floor((t+4)/5)*Math.floor((e+4)/5)*16;case Kd:return Math.floor((t+5)/6)*Math.floor((e+4)/5)*16;case Zd:return Math.floor((t+5)/6)*Math.floor((e+5)/6)*16;case Qd:return Math.floor((t+7)/8)*Math.floor((e+4)/5)*16;case Jd:return Math.floor((t+7)/8)*Math.floor((e+5)/6)*16;case eh:return Math.floor((t+7)/8)*Math.floor((e+7)/8)*16;case th:return Math.floor((t+9)/10)*Math.floor((e+4)/5)*16;case nh:return Math.floor((t+9)/10)*Math.floor((e+5)/6)*16;case ih:return Math.floor((t+9)/10)*Math.floor((e+7)/8)*16;case rh:return Math.floor((t+9)/10)*Math.floor((e+9)/10)*16;case sh:return Math.floor((t+11)/12)*Math.floor((e+9)/10)*16;case oh:return Math.floor((t+11)/12)*Math.floor((e+11)/12)*16;case Yl:case ah:case lh:return Math.ceil(t/4)*Math.ceil(e/4)*16;case PS:case uh:return Math.ceil(t/4)*Math.ceil(e/4)*8;case ch:case fh:return Math.ceil(t/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function $D(t){switch(t){case Ui:case xS:return{byteLength:1,components:1};case Ea:case SS:case Ia:return{byteLength:2,components:1};case Hp:case Gp:return{byteLength:2,components:4};case Jr:case zp:case Ei:return{byteLength:4,components:1};case MS:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${t}.`)}function qD(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new We,c=new WeakMap;let d;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(R,M){return p?new OffscreenCanvas(R,M):Cu("canvas")}function y(R,M,O){let Z=1;const ee=we(R);if((ee.width>O||ee.height>O)&&(Z=O/Math.max(ee.width,ee.height)),Z<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const Y=Math.floor(Z*ee.width),Me=Math.floor(Z*ee.height);d===void 0&&(d=_(Y,Me));const ue=M?_(Y,Me):d;return ue.width=Y,ue.height=Me,ue.getContext("2d").drawImage(R,0,0,Y,Me),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ee.width+"x"+ee.height+") to ("+Y+"x"+Me+")."),ue}else return"data"in R&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ee.width+"x"+ee.height+")."),R;return R}function g(R){return R.generateMipmaps}function h(R){t.generateMipmap(R)}function m(R){return R.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?t.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function v(R,M,O,Z,ee=!1){if(R!==null){if(t[R]!==void 0)return t[R];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let Y=M;if(M===t.RED&&(O===t.FLOAT&&(Y=t.R32F),O===t.HALF_FLOAT&&(Y=t.R16F),O===t.UNSIGNED_BYTE&&(Y=t.R8)),M===t.RED_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.R8UI),O===t.UNSIGNED_SHORT&&(Y=t.R16UI),O===t.UNSIGNED_INT&&(Y=t.R32UI),O===t.BYTE&&(Y=t.R8I),O===t.SHORT&&(Y=t.R16I),O===t.INT&&(Y=t.R32I)),M===t.RG&&(O===t.FLOAT&&(Y=t.RG32F),O===t.HALF_FLOAT&&(Y=t.RG16F),O===t.UNSIGNED_BYTE&&(Y=t.RG8)),M===t.RG_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RG8UI),O===t.UNSIGNED_SHORT&&(Y=t.RG16UI),O===t.UNSIGNED_INT&&(Y=t.RG32UI),O===t.BYTE&&(Y=t.RG8I),O===t.SHORT&&(Y=t.RG16I),O===t.INT&&(Y=t.RG32I)),M===t.RGB_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGB8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGB16UI),O===t.UNSIGNED_INT&&(Y=t.RGB32UI),O===t.BYTE&&(Y=t.RGB8I),O===t.SHORT&&(Y=t.RGB16I),O===t.INT&&(Y=t.RGB32I)),M===t.RGBA_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGBA8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGBA16UI),O===t.UNSIGNED_INT&&(Y=t.RGBA32UI),O===t.BYTE&&(Y=t.RGBA8I),O===t.SHORT&&(Y=t.RGBA16I),O===t.INT&&(Y=t.RGBA32I)),M===t.RGB&&O===t.UNSIGNED_INT_5_9_9_9_REV&&(Y=t.RGB9_E5),M===t.RGBA){const Me=ee?Zu:Ye.getTransfer(Z);O===t.FLOAT&&(Y=t.RGBA32F),O===t.HALF_FLOAT&&(Y=t.RGBA16F),O===t.UNSIGNED_BYTE&&(Y=Me===tt?t.SRGB8_ALPHA8:t.RGBA8),O===t.UNSIGNED_SHORT_4_4_4_4&&(Y=t.RGBA4),O===t.UNSIGNED_SHORT_5_5_5_1&&(Y=t.RGB5_A1)}return(Y===t.R16F||Y===t.R32F||Y===t.RG16F||Y===t.RG32F||Y===t.RGBA16F||Y===t.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function x(R,M){let O;return R?M===null||M===Jr||M===ao?O=t.DEPTH24_STENCIL8:M===Ei?O=t.DEPTH32F_STENCIL8:M===Ea&&(O=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Jr||M===ao?O=t.DEPTH_COMPONENT24:M===Ei?O=t.DEPTH_COMPONENT32F:M===Ea&&(O=t.DEPTH_COMPONENT16),O}function P(R,M){return g(R)===!0||R.isFramebufferTexture&&R.minFilter!==qn&&R.minFilter!==ii?Math.log2(Math.max(M.width,M.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?M.mipmaps.length:1}function A(R){const M=R.target;M.removeEventListener("dispose",A),C(M),M.isVideoTexture&&c.delete(M)}function w(R){const M=R.target;M.removeEventListener("dispose",w),S(M)}function C(R){const M=i.get(R);if(M.__webglInit===void 0)return;const O=R.source,Z=f.get(O);if(Z){const ee=Z[M.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&T(R),Object.keys(Z).length===0&&f.delete(O)}i.remove(R)}function T(R){const M=i.get(R);t.deleteTexture(M.__webglTexture);const O=R.source,Z=f.get(O);delete Z[M.__cacheKey],o.memory.textures--}function S(R){const M=i.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),i.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(M.__webglFramebuffer[Z]))for(let ee=0;ee<M.__webglFramebuffer[Z].length;ee++)t.deleteFramebuffer(M.__webglFramebuffer[Z][ee]);else t.deleteFramebuffer(M.__webglFramebuffer[Z]);M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer[Z])}else{if(Array.isArray(M.__webglFramebuffer))for(let Z=0;Z<M.__webglFramebuffer.length;Z++)t.deleteFramebuffer(M.__webglFramebuffer[Z]);else t.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&t.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let Z=0;Z<M.__webglColorRenderbuffer.length;Z++)M.__webglColorRenderbuffer[Z]&&t.deleteRenderbuffer(M.__webglColorRenderbuffer[Z]);M.__webglDepthRenderbuffer&&t.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const O=R.textures;for(let Z=0,ee=O.length;Z<ee;Z++){const Y=i.get(O[Z]);Y.__webglTexture&&(t.deleteTexture(Y.__webglTexture),o.memory.textures--),i.remove(O[Z])}i.remove(R)}let b=0;function z(){b=0}function V(){const R=b;return R>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+r.maxTextures),b+=1,R}function q(R){const M=[];return M.push(R.wrapS),M.push(R.wrapT),M.push(R.wrapR||0),M.push(R.magFilter),M.push(R.minFilter),M.push(R.anisotropy),M.push(R.internalFormat),M.push(R.format),M.push(R.type),M.push(R.generateMipmaps),M.push(R.premultiplyAlpha),M.push(R.flipY),M.push(R.unpackAlignment),M.push(R.colorSpace),M.join()}function J(R,M){const O=i.get(R);if(R.isVideoTexture&&Ce(R),R.isRenderTargetTexture===!1&&R.version>0&&O.__version!==R.version){const Z=R.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{G(O,R,M);return}}n.bindTexture(t.TEXTURE_2D,O.__webglTexture,t.TEXTURE0+M)}function X(R,M){const O=i.get(R);if(R.version>0&&O.__version!==R.version){G(O,R,M);return}n.bindTexture(t.TEXTURE_2D_ARRAY,O.__webglTexture,t.TEXTURE0+M)}function j(R,M){const O=i.get(R);if(R.version>0&&O.__version!==R.version){G(O,R,M);return}n.bindTexture(t.TEXTURE_3D,O.__webglTexture,t.TEXTURE0+M)}function L(R,M){const O=i.get(R);if(R.version>0&&O.__version!==R.version){ne(O,R,M);return}n.bindTexture(t.TEXTURE_CUBE_MAP,O.__webglTexture,t.TEXTURE0+M)}const W={[kd]:t.REPEAT,[Gr]:t.CLAMP_TO_EDGE,[Bd]:t.MIRRORED_REPEAT},K={[qn]:t.NEAREST,[UR]:t.NEAREST_MIPMAP_NEAREST,[al]:t.NEAREST_MIPMAP_LINEAR,[ii]:t.LINEAR,[zc]:t.LINEAR_MIPMAP_NEAREST,[Wr]:t.LINEAR_MIPMAP_LINEAR},oe={[BR]:t.NEVER,[jR]:t.ALWAYS,[VR]:t.LESS,[bS]:t.LEQUAL,[zR]:t.EQUAL,[WR]:t.GEQUAL,[HR]:t.GREATER,[GR]:t.NOTEQUAL};function Se(R,M){if(M.type===Ei&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===ii||M.magFilter===zc||M.magFilter===al||M.magFilter===Wr||M.minFilter===ii||M.minFilter===zc||M.minFilter===al||M.minFilter===Wr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(R,t.TEXTURE_WRAP_S,W[M.wrapS]),t.texParameteri(R,t.TEXTURE_WRAP_T,W[M.wrapT]),(R===t.TEXTURE_3D||R===t.TEXTURE_2D_ARRAY)&&t.texParameteri(R,t.TEXTURE_WRAP_R,W[M.wrapR]),t.texParameteri(R,t.TEXTURE_MAG_FILTER,K[M.magFilter]),t.texParameteri(R,t.TEXTURE_MIN_FILTER,K[M.minFilter]),M.compareFunction&&(t.texParameteri(R,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(R,t.TEXTURE_COMPARE_FUNC,oe[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===qn||M.minFilter!==al&&M.minFilter!==Wr||M.type===Ei&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");t.texParameterf(R,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function qe(R,M){let O=!1;R.__webglInit===void 0&&(R.__webglInit=!0,M.addEventListener("dispose",A));const Z=M.source;let ee=f.get(Z);ee===void 0&&(ee={},f.set(Z,ee));const Y=q(M);if(Y!==R.__cacheKey){ee[Y]===void 0&&(ee[Y]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,O=!0),ee[Y].usedTimes++;const Me=ee[R.__cacheKey];Me!==void 0&&(ee[R.__cacheKey].usedTimes--,Me.usedTimes===0&&T(M)),R.__cacheKey=Y,R.__webglTexture=ee[Y].texture}return O}function G(R,M,O){let Z=t.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(Z=t.TEXTURE_2D_ARRAY),M.isData3DTexture&&(Z=t.TEXTURE_3D);const ee=qe(R,M),Y=M.source;n.bindTexture(Z,R.__webglTexture,t.TEXTURE0+O);const Me=i.get(Y);if(Y.version!==Me.__version||ee===!0){n.activeTexture(t.TEXTURE0+O);const ue=Ye.getPrimaries(Ye.workingColorSpace),me=M.colorSpace===Qi?null:Ye.getPrimaries(M.colorSpace),Xe=M.colorSpace===Qi||ue===me?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xe);let ie=y(M.image,!1,r.maxTextureSize);ie=ot(M,ie);const ge=s.convert(M.format,M.colorSpace),Re=s.convert(M.type);let be=v(M.internalFormat,ge,Re,M.colorSpace,M.isVideoTexture);Se(Z,M);let ve;const He=M.mipmaps,Fe=M.isVideoTexture!==!0,it=Me.__version===void 0||ee===!0,D=Y.dataReady,le=P(M,ie);if(M.isDepthTexture)be=x(M.format===lo,M.type),it&&(Fe?n.texStorage2D(t.TEXTURE_2D,1,be,ie.width,ie.height):n.texImage2D(t.TEXTURE_2D,0,be,ie.width,ie.height,0,ge,Re,null));else if(M.isDataTexture)if(He.length>0){Fe&&it&&n.texStorage2D(t.TEXTURE_2D,le,be,He[0].width,He[0].height);for(let H=0,Q=He.length;H<Q;H++)ve=He[H],Fe?D&&n.texSubImage2D(t.TEXTURE_2D,H,0,0,ve.width,ve.height,ge,Re,ve.data):n.texImage2D(t.TEXTURE_2D,H,be,ve.width,ve.height,0,ge,Re,ve.data);M.generateMipmaps=!1}else Fe?(it&&n.texStorage2D(t.TEXTURE_2D,le,be,ie.width,ie.height),D&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ie.width,ie.height,ge,Re,ie.data)):n.texImage2D(t.TEXTURE_2D,0,be,ie.width,ie.height,0,ge,Re,ie.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Fe&&it&&n.texStorage3D(t.TEXTURE_2D_ARRAY,le,be,He[0].width,He[0].height,ie.depth);for(let H=0,Q=He.length;H<Q;H++)if(ve=He[H],M.format!==Xn)if(ge!==null)if(Fe){if(D)if(M.layerUpdates.size>0){const de=C0(ve.width,ve.height,M.format,M.type);for(const ce of M.layerUpdates){const Ie=ve.data.subarray(ce*de/ve.data.BYTES_PER_ELEMENT,(ce+1)*de/ve.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,H,0,0,ce,ve.width,ve.height,1,ge,Ie)}M.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,H,0,0,0,ve.width,ve.height,ie.depth,ge,ve.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,H,be,ve.width,ve.height,ie.depth,0,ve.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Fe?D&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,H,0,0,0,ve.width,ve.height,ie.depth,ge,Re,ve.data):n.texImage3D(t.TEXTURE_2D_ARRAY,H,be,ve.width,ve.height,ie.depth,0,ge,Re,ve.data)}else{Fe&&it&&n.texStorage2D(t.TEXTURE_2D,le,be,He[0].width,He[0].height);for(let H=0,Q=He.length;H<Q;H++)ve=He[H],M.format!==Xn?ge!==null?Fe?D&&n.compressedTexSubImage2D(t.TEXTURE_2D,H,0,0,ve.width,ve.height,ge,ve.data):n.compressedTexImage2D(t.TEXTURE_2D,H,be,ve.width,ve.height,0,ve.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Fe?D&&n.texSubImage2D(t.TEXTURE_2D,H,0,0,ve.width,ve.height,ge,Re,ve.data):n.texImage2D(t.TEXTURE_2D,H,be,ve.width,ve.height,0,ge,Re,ve.data)}else if(M.isDataArrayTexture)if(Fe){if(it&&n.texStorage3D(t.TEXTURE_2D_ARRAY,le,be,ie.width,ie.height,ie.depth),D)if(M.layerUpdates.size>0){const H=C0(ie.width,ie.height,M.format,M.type);for(const Q of M.layerUpdates){const de=ie.data.subarray(Q*H/ie.data.BYTES_PER_ELEMENT,(Q+1)*H/ie.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,Q,ie.width,ie.height,1,ge,Re,de)}M.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,ge,Re,ie.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,be,ie.width,ie.height,ie.depth,0,ge,Re,ie.data);else if(M.isData3DTexture)Fe?(it&&n.texStorage3D(t.TEXTURE_3D,le,be,ie.width,ie.height,ie.depth),D&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,ge,Re,ie.data)):n.texImage3D(t.TEXTURE_3D,0,be,ie.width,ie.height,ie.depth,0,ge,Re,ie.data);else if(M.isFramebufferTexture){if(it)if(Fe)n.texStorage2D(t.TEXTURE_2D,le,be,ie.width,ie.height);else{let H=ie.width,Q=ie.height;for(let de=0;de<le;de++)n.texImage2D(t.TEXTURE_2D,de,be,H,Q,0,ge,Re,null),H>>=1,Q>>=1}}else if(He.length>0){if(Fe&&it){const H=we(He[0]);n.texStorage2D(t.TEXTURE_2D,le,be,H.width,H.height)}for(let H=0,Q=He.length;H<Q;H++)ve=He[H],Fe?D&&n.texSubImage2D(t.TEXTURE_2D,H,0,0,ge,Re,ve):n.texImage2D(t.TEXTURE_2D,H,be,ge,Re,ve);M.generateMipmaps=!1}else if(Fe){if(it){const H=we(ie);n.texStorage2D(t.TEXTURE_2D,le,be,H.width,H.height)}D&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ge,Re,ie)}else n.texImage2D(t.TEXTURE_2D,0,be,ge,Re,ie);g(M)&&h(Z),Me.__version=Y.version,M.onUpdate&&M.onUpdate(M)}R.__version=M.version}function ne(R,M,O){if(M.image.length!==6)return;const Z=qe(R,M),ee=M.source;n.bindTexture(t.TEXTURE_CUBE_MAP,R.__webglTexture,t.TEXTURE0+O);const Y=i.get(ee);if(ee.version!==Y.__version||Z===!0){n.activeTexture(t.TEXTURE0+O);const Me=Ye.getPrimaries(Ye.workingColorSpace),ue=M.colorSpace===Qi?null:Ye.getPrimaries(M.colorSpace),me=M.colorSpace===Qi||Me===ue?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,me);const Xe=M.isCompressedTexture||M.image[0].isCompressedTexture,ie=M.image[0]&&M.image[0].isDataTexture,ge=[];for(let Q=0;Q<6;Q++)!Xe&&!ie?ge[Q]=y(M.image[Q],!0,r.maxCubemapSize):ge[Q]=ie?M.image[Q].image:M.image[Q],ge[Q]=ot(M,ge[Q]);const Re=ge[0],be=s.convert(M.format,M.colorSpace),ve=s.convert(M.type),He=v(M.internalFormat,be,ve,M.colorSpace),Fe=M.isVideoTexture!==!0,it=Y.__version===void 0||Z===!0,D=ee.dataReady;let le=P(M,Re);Se(t.TEXTURE_CUBE_MAP,M);let H;if(Xe){Fe&&it&&n.texStorage2D(t.TEXTURE_CUBE_MAP,le,He,Re.width,Re.height);for(let Q=0;Q<6;Q++){H=ge[Q].mipmaps;for(let de=0;de<H.length;de++){const ce=H[de];M.format!==Xn?be!==null?Fe?D&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de,0,0,ce.width,ce.height,be,ce.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de,He,ce.width,ce.height,0,ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Fe?D&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de,0,0,ce.width,ce.height,be,ve,ce.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de,He,ce.width,ce.height,0,be,ve,ce.data)}}}else{if(H=M.mipmaps,Fe&&it){H.length>0&&le++;const Q=we(ge[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,le,He,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(ie){Fe?D&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,ge[Q].width,ge[Q].height,be,ve,ge[Q].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,He,ge[Q].width,ge[Q].height,0,be,ve,ge[Q].data);for(let de=0;de<H.length;de++){const Ie=H[de].image[Q].image;Fe?D&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de+1,0,0,Ie.width,Ie.height,be,ve,Ie.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de+1,He,Ie.width,Ie.height,0,be,ve,Ie.data)}}else{Fe?D&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,be,ve,ge[Q]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,He,be,ve,ge[Q]);for(let de=0;de<H.length;de++){const ce=H[de];Fe?D&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de+1,0,0,be,ve,ce.image[Q]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,de+1,He,be,ve,ce.image[Q])}}}g(M)&&h(t.TEXTURE_CUBE_MAP),Y.__version=ee.version,M.onUpdate&&M.onUpdate(M)}R.__version=M.version}function pe(R,M,O,Z,ee,Y){const Me=s.convert(O.format,O.colorSpace),ue=s.convert(O.type),me=v(O.internalFormat,Me,ue,O.colorSpace),Xe=i.get(M),ie=i.get(O);if(ie.__renderTarget=M,!Xe.__hasExternalTextures){const ge=Math.max(1,M.width>>Y),Re=Math.max(1,M.height>>Y);ee===t.TEXTURE_3D||ee===t.TEXTURE_2D_ARRAY?n.texImage3D(ee,Y,me,ge,Re,M.depth,0,Me,ue,null):n.texImage2D(ee,Y,me,ge,Re,0,Me,ue,null)}n.bindFramebuffer(t.FRAMEBUFFER,R),ze(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Z,ee,ie.__webglTexture,0,Ve(M)):(ee===t.TEXTURE_2D||ee>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,Z,ee,ie.__webglTexture,Y),n.bindFramebuffer(t.FRAMEBUFFER,null)}function se(R,M,O){if(t.bindRenderbuffer(t.RENDERBUFFER,R),M.depthBuffer){const Z=M.depthTexture,ee=Z&&Z.isDepthTexture?Z.type:null,Y=x(M.stencilBuffer,ee),Me=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ue=Ve(M);ze(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ue,Y,M.width,M.height):O?t.renderbufferStorageMultisample(t.RENDERBUFFER,ue,Y,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,Y,M.width,M.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Me,t.RENDERBUFFER,R)}else{const Z=M.textures;for(let ee=0;ee<Z.length;ee++){const Y=Z[ee],Me=s.convert(Y.format,Y.colorSpace),ue=s.convert(Y.type),me=v(Y.internalFormat,Me,ue,Y.colorSpace),Xe=Ve(M);O&&ze(M)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,Xe,me,M.width,M.height):ze(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Xe,me,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,me,M.width,M.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Pe(R,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,R),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=i.get(M.depthTexture);Z.__renderTarget=M,(!Z.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),J(M.depthTexture,0);const ee=Z.__webglTexture,Y=Ve(M);if(M.depthTexture.format===Xs)ze(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ee,0,Y):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ee,0);else if(M.depthTexture.format===lo)ze(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ee,0,Y):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ee,0);else throw new Error("Unknown depthTexture format")}function De(R){const M=i.get(R),O=R.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==R.depthTexture){const Z=R.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),Z){const ee=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,Z.removeEventListener("dispose",ee)};Z.addEventListener("dispose",ee),M.__depthDisposeCallback=ee}M.__boundDepthTexture=Z}if(R.depthTexture&&!M.__autoAllocateDepthBuffer){if(O)throw new Error("target.depthTexture not supported in Cube render targets");Pe(M.__webglFramebuffer,R)}else if(O){M.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[Z]),M.__webglDepthbuffer[Z]===void 0)M.__webglDepthbuffer[Z]=t.createRenderbuffer(),se(M.__webglDepthbuffer[Z],R,!1);else{const ee=R.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Y=M.__webglDepthbuffer[Z];t.bindRenderbuffer(t.RENDERBUFFER,Y),t.framebufferRenderbuffer(t.FRAMEBUFFER,ee,t.RENDERBUFFER,Y)}}else if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=t.createRenderbuffer(),se(M.__webglDepthbuffer,R,!1);else{const Z=R.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ee=M.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ee),t.framebufferRenderbuffer(t.FRAMEBUFFER,Z,t.RENDERBUFFER,ee)}n.bindFramebuffer(t.FRAMEBUFFER,null)}function ke(R,M,O){const Z=i.get(R);M!==void 0&&pe(Z.__webglFramebuffer,R,R.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),O!==void 0&&De(R)}function dt(R){const M=R.texture,O=i.get(R),Z=i.get(M);R.addEventListener("dispose",w);const ee=R.textures,Y=R.isWebGLCubeRenderTarget===!0,Me=ee.length>1;if(Me||(Z.__webglTexture===void 0&&(Z.__webglTexture=t.createTexture()),Z.__version=M.version,o.memory.textures++),Y){O.__webglFramebuffer=[];for(let ue=0;ue<6;ue++)if(M.mipmaps&&M.mipmaps.length>0){O.__webglFramebuffer[ue]=[];for(let me=0;me<M.mipmaps.length;me++)O.__webglFramebuffer[ue][me]=t.createFramebuffer()}else O.__webglFramebuffer[ue]=t.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){O.__webglFramebuffer=[];for(let ue=0;ue<M.mipmaps.length;ue++)O.__webglFramebuffer[ue]=t.createFramebuffer()}else O.__webglFramebuffer=t.createFramebuffer();if(Me)for(let ue=0,me=ee.length;ue<me;ue++){const Xe=i.get(ee[ue]);Xe.__webglTexture===void 0&&(Xe.__webglTexture=t.createTexture(),o.memory.textures++)}if(R.samples>0&&ze(R)===!1){O.__webglMultisampledFramebuffer=t.createFramebuffer(),O.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let ue=0;ue<ee.length;ue++){const me=ee[ue];O.__webglColorRenderbuffer[ue]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,O.__webglColorRenderbuffer[ue]);const Xe=s.convert(me.format,me.colorSpace),ie=s.convert(me.type),ge=v(me.internalFormat,Xe,ie,me.colorSpace,R.isXRRenderTarget===!0),Re=Ve(R);t.renderbufferStorageMultisample(t.RENDERBUFFER,Re,ge,R.width,R.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.RENDERBUFFER,O.__webglColorRenderbuffer[ue])}t.bindRenderbuffer(t.RENDERBUFFER,null),R.depthBuffer&&(O.__webglDepthRenderbuffer=t.createRenderbuffer(),se(O.__webglDepthRenderbuffer,R,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(Y){n.bindTexture(t.TEXTURE_CUBE_MAP,Z.__webglTexture),Se(t.TEXTURE_CUBE_MAP,M);for(let ue=0;ue<6;ue++)if(M.mipmaps&&M.mipmaps.length>0)for(let me=0;me<M.mipmaps.length;me++)pe(O.__webglFramebuffer[ue][me],R,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ue,me);else pe(O.__webglFramebuffer[ue],R,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0);g(M)&&h(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Me){for(let ue=0,me=ee.length;ue<me;ue++){const Xe=ee[ue],ie=i.get(Xe);n.bindTexture(t.TEXTURE_2D,ie.__webglTexture),Se(t.TEXTURE_2D,Xe),pe(O.__webglFramebuffer,R,Xe,t.COLOR_ATTACHMENT0+ue,t.TEXTURE_2D,0),g(Xe)&&h(t.TEXTURE_2D)}n.unbindTexture()}else{let ue=t.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ue=R.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ue,Z.__webglTexture),Se(ue,M),M.mipmaps&&M.mipmaps.length>0)for(let me=0;me<M.mipmaps.length;me++)pe(O.__webglFramebuffer[me],R,M,t.COLOR_ATTACHMENT0,ue,me);else pe(O.__webglFramebuffer,R,M,t.COLOR_ATTACHMENT0,ue,0);g(M)&&h(ue),n.unbindTexture()}R.depthBuffer&&De(R)}function je(R){const M=R.textures;for(let O=0,Z=M.length;O<Z;O++){const ee=M[O];if(g(ee)){const Y=m(R),Me=i.get(ee).__webglTexture;n.bindTexture(Y,Me),h(Y),n.unbindTexture()}}}const St=[],U=[];function Sn(R){if(R.samples>0){if(ze(R)===!1){const M=R.textures,O=R.width,Z=R.height;let ee=t.COLOR_BUFFER_BIT;const Y=R.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Me=i.get(R),ue=M.length>1;if(ue)for(let me=0;me<M.length;me++)n.bindFramebuffer(t.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Me.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Me.__webglFramebuffer);for(let me=0;me<M.length;me++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(ee|=t.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(ee|=t.STENCIL_BUFFER_BIT)),ue){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Me.__webglColorRenderbuffer[me]);const Xe=i.get(M[me]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Xe,0)}t.blitFramebuffer(0,0,O,Z,0,0,O,Z,ee,t.NEAREST),l===!0&&(St.length=0,U.length=0,St.push(t.COLOR_ATTACHMENT0+me),R.depthBuffer&&R.resolveDepthBuffer===!1&&(St.push(Y),U.push(Y),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,U)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,St))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ue)for(let me=0;me<M.length;me++){n.bindFramebuffer(t.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.RENDERBUFFER,Me.__webglColorRenderbuffer[me]);const Xe=i.get(M[me]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Me.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.TEXTURE_2D,Xe,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Me.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){const M=R.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[M])}}}function Ve(R){return Math.min(r.maxSamples,R.samples)}function ze(R){const M=i.get(R);return R.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Ce(R){const M=o.render.frame;c.get(R)!==M&&(c.set(R,M),R.update())}function ot(R,M){const O=R.colorSpace,Z=R.format,ee=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||O!==mo&&O!==Qi&&(Ye.getTransfer(O)===tt?(Z!==Xn||ee!==Ui)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",O)),M}function we(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(u.width=R.naturalWidth||R.width,u.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(u.width=R.displayWidth,u.height=R.displayHeight):(u.width=R.width,u.height=R.height),u}this.allocateTextureUnit=V,this.resetTextureUnits=z,this.setTexture2D=J,this.setTexture2DArray=X,this.setTexture3D=j,this.setTextureCube=L,this.rebindTextures=ke,this.setupRenderTarget=dt,this.updateRenderTargetMipmap=je,this.updateMultisampleRenderTarget=Sn,this.setupDepthRenderbuffer=De,this.setupFrameBufferTexture=pe,this.useMultisampledRTT=ze}function KD(t,e){function n(i,r=Qi){let s;const o=Ye.getTransfer(r);if(i===Ui)return t.UNSIGNED_BYTE;if(i===Hp)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Gp)return t.UNSIGNED_SHORT_5_5_5_1;if(i===MS)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===xS)return t.BYTE;if(i===SS)return t.SHORT;if(i===Ea)return t.UNSIGNED_SHORT;if(i===zp)return t.INT;if(i===Jr)return t.UNSIGNED_INT;if(i===Ei)return t.FLOAT;if(i===Ia)return t.HALF_FLOAT;if(i===ES)return t.ALPHA;if(i===TS)return t.RGB;if(i===Xn)return t.RGBA;if(i===wS)return t.LUMINANCE;if(i===AS)return t.LUMINANCE_ALPHA;if(i===Xs)return t.DEPTH_COMPONENT;if(i===lo)return t.DEPTH_STENCIL;if(i===CS)return t.RED;if(i===Wp)return t.RED_INTEGER;if(i===RS)return t.RG;if(i===jp)return t.RG_INTEGER;if(i===Xp)return t.RGBA_INTEGER;if(i===Gl||i===Wl||i===jl||i===Xl)if(o===tt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Gl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Wl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===jl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Xl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Gl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Wl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===jl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Xl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Vd||i===zd||i===Hd||i===Gd)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Vd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===zd)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Hd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Gd)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Wd||i===jd||i===Xd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Wd||i===jd)return o===tt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Xd)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Yd||i===$d||i===qd||i===Kd||i===Zd||i===Qd||i===Jd||i===eh||i===th||i===nh||i===ih||i===rh||i===sh||i===oh)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Yd)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===$d)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===qd)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Kd)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Zd)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Qd)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Jd)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===eh)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===th)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===nh)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ih)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===rh)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===sh)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===oh)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Yl||i===ah||i===lh)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Yl)return o===tt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===ah)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===lh)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===PS||i===uh||i===ch||i===fh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Yl)return s.COMPRESSED_RED_RGTC1_EXT;if(i===uh)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===ch)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===fh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ao?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}class ZD extends Pn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class ks extends Xt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const QD={type:"move"};class vf{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ks,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ks,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new F,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new F),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ks,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new F,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new F),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,u=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(u&&e.hand){o=!0;for(const y of e.hand.values()){const g=n.getJointPose(y,i),h=this._getHandJoint(u,y);g!==null&&(h.matrix.fromArray(g.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=g.radius),h.visible=g!==null}const c=u.joints["index-finger-tip"],d=u.joints["thumb-tip"],f=c.position.distanceTo(d.position),p=.02,_=.005;u.inputState.pinching&&f>p+_?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&f<=p-_&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(QD)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),u!==null&&(u.visible=o!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new ks;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}const JD=`
void main() {
...
`],technologies:["C","C++"],liveDemo:null,github:"https://github.com/Tushar-Wagdare/CPPWrapperForCFileHandling",image:null,date:"02/2025",details:[""]},{title:"Vaat Disu De",description:"A cinematic sequence rendered in real-time using C and OpenGL, involving a perlin noise and a real-time spline implementation.",technologies:["C","OpenGL"],liveDemo:"https://www.youtube.com/watch?v=QFp7CFoTlfg",github:"https://github.com/Tushar-Wagdare/DS_Demo-VaatDisuDe",image:null,date:"03/2024",details:[]},{title:"Sunderkand",description:"Created a mythological story-based cinematic sequence using C and OpenGL.",technologies:["C","OpenGL"],liveDemo:"https://www.youtube.com/watch?v=D8MvifK1kl8",github:"https://github.com/Tushar-Wagdare/Sunderkand_Demo_RTR",image:null,date:"10/2023",details:[]},{title:"Dashavtaram",description:"Created a mythological story-based narration and cinematic sequence using C++ and OpenGL.",technologies:["C++","OpenGL"],liveDemo:"https://www.youtube.com/watch?v=z0xTpobLRXI",github:null,image:null,date:"01/2025",details:[]},{title:"OpenGL-ModelLoadingAndAnimation",description:"OpenGL model loading and skeletal animation examples. It provides a practical implementation usng assimp model loader and glm for math operations.",technologies:["C++","OpenGL","GLSL","Assimp","glm"],liveDemo:"https://www.youtube.com/watch?v=KI7ARaL5nyY",github:"https://github.com/Tushar-Wagdare/OpenGL-ModelLoadingAndAnimation",image:null,date:"10/2024",details:[]},{title:"OpenGL-PBR",description:"This project demonstrates Physically Based Rendering (PBR) techniques in OpenGL using C++ and GLSL. It explores a few PBR techniques: Normal Mapping, Parallax Mapping, and Image-Based Lighting (IBL), to create more realistic and visually appealing rendering.",technologies:["C++","OpenGL","GLSL"],liveDemo:"https://www.youtube.com/watch?v=WpxeeMz6_Bw",github:"https://github.com/Tushar-Wagdare/OpenGL-PBR",image:null,date:"4/2025",details:[]},{title:"OpenGL-Tessellation",description:"This project demonstrates the implementation of Tessellation in OpenGL using C++ and GLSL. Tessellation is a process that subdivides high-order surfaces into triangles, providing better rendering performance and a more detailed look with a lower memory footprint compared to complex meshes.",technologies:["C++","OpenGL","GLSL"],liveDemo:"https://www.youtube.com/watch?v=Sx4YjVkJDxQ",github:"https://github.com/Tushar-Wagdare/OpenGL-Tesselation",image:null,date:"5/2025",details:[]},{title:"OpenGL-HeightMap",description:"This project demonstrates the implementation of HeightMap in OpenGL using C++ and GLSL.",technologies:["C++","OpenGL","GLSL"],liveDemo:"https://www.youtube.com/watch?v=SkPq1Y5yoWk",github:"https://github.com/Tushar-Wagdare/OpenGL-Tesselation",image:null,date:"5/2025",details:[]},{title:"OpenGL-GeometryShader",description:"This project demonstrates the implementation of Geometry Shaders in OpenGL using C++ and GLSL. Geometry shaders run after vertex shaders and before fragment shaders, allowing you to generate new primitives (points, lines, or triangles) from input primitives, enabling effects like mesh explosion, wireframe rendering, and more.",technologies:["C++","OpenGL","GLSL"],liveDemo:"https://www.youtube.com/watch?v=YSVAuS9mxgY",github:"https://github.com/Tushar-Wagdare/OpenGL-GeometryShader",image:null,date:"5/2025",details:[]}],ZS=[{degree:"Real Time Rendering",institution:"Astromedicomp",dates:"2023 - 2025",details:"C | C++ | Javascript | Java | OpenGL | DirectX11 | CUDA | OpenCL",grade:"8.5 / 10.0",location:"Pune, India"},{degree:"Bachelor of Engineering",institution:"D.Y Patil Institute Of Engineering And Technology Ambi",dates:"2018 - 2022",details:"Mechanical Engineering",grade:"8.0 / 10.0",location:"Pune, India"},{degree:"HSC",institution:"Deogiri Collage Aurangabad",dates:"2016 - 2018",details:"PCM",grade:"65%",location:"Aurangabad, India"}],QS=[{title:"Software Developement",company:null,dates:null,location:null,responsibilities:["Developed 100+ applications using Modern OpenGL across 6 different platforms","Personal work showcasing various applications developed using OpenGL","Demonstrated ability to work with various operating systems and development environments","Implemented complex features including optimization and performance monitoring","Collaborated with team members to ensure code quality and functionality"]}],br={email:"tushartwagdare@gmail.com",phone:"+91 7083666972",linkedin:"https://www.linkedin.com/in/tushar-wagdare-715438245/",github:"https://github.com/Tushar-Wagdare",location:"Pune, India"};function pI(){return $.jsxs("section",{id:"home",className:"relative min-h-screen w-full overflow-hidden",children:[$.jsx(hI,{}),$.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center text-center",children:[$.jsx(ol.h1,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},transition:{duration:.5},className:"text-5xl font-bold mb-4 text-white",children:Hn.name}),$.jsx(ol.h2,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},transition:{duration:.5,delay:.2},className:"text-2xl text-gray-300 mb-8",children:Hn.title}),$.jsx(ol.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.5,delay:.4},children:$.jsx("a",{href:"#about",className:"bg-blue-600 text-white px-6 py-3 rounded-full font-medium hover:bg-blue-700 transition-colors",children:"Learn More"})})]}),$.jsx(ol.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.5,delay:.6},className:"absolute bottom-10 left-1/2 transform -translate-x-1/2",children:$.jsx(eR,{className:"animate-bounce text-white",size:32})})]})}function mI(){return $.jsx("section",{id:"about",className:"py-20 bg-gray-800",children:$.jsxs("div",{className:"container mx-auto px-6",children:[$.jsx("h2",{className:"text-3xl font-bold mb-8",children:"About Me"}),$.jsx("p",{className:"text-lg text-gray-300 mb-6",children:Hn.summary}),$.jsxs("ul",{className:"list-none text-gray-400",children:[$.jsxs("li",{children:[$.jsx("strong",{children:"Name:"})," ",Hn.name]}),$.jsxs("li",{children:[$.jsx("strong",{children:"Title:"})," ",Hn.title]}),$.jsxs("li",{children:[$.jsx("strong",{children:"Location:"})," ",Hn.location]}),$.jsxs("li",{children:[$.jsx("strong",{children:"Email:"})," ",$.jsx("a",{href:`mailto:${Hn.email}`,className:"text-blue-500 hover:text-blue-400",children:Hn.email})]}),$.jsxs("li",{children:[$.jsx("strong",{children:"LinkedIn:"})," ",$.jsx("a",{href:Hn.linkedin,target:"_blank",rel:"noopener noreferrer",className:"text-blue-500 hover:text-blue-400",children:"LinkedIn"})]}),$.jsxs("li",{children:[$.jsx("strong",{children:"GitHub:"})," ",$.jsx("a",{href:Hn.github,target:"_blank",rel:"noopener noreferrer",className:"text-blue-500 hover:text-blue-400",children:"GitHub"})]})]})]})})}function gI(){return $.jsx("section",{id:"experience",className:"py-20",children:$.jsxs("div",{className:"container mx-auto px-6",children:[$.jsx("h2",{className:"text-3xl font-bold mb-8",children:"Relevant  Experience"}),QS.map((t,e)=>$.jsxs("div",{className:"bg-gray-800 rounded-lg p-6 mb-6",children:[$.jsx("h3",{className:"text-xl font-semibold mb-2",children:t.title}),$.jsxs("p",{className:"text-gray-400 mb-4",children:[t.company,"  ",t.dates,"  ",t.location]}),$.jsx("ul",{className:"list-disc list-inside text-gray-300 space-y-2",children:t.responsibilities.map((n,i)=>$.jsx("li",{children:n},i))})]},e))]})})}function vI(){return $.jsx("section",{id:"skills",className:"py-20 bg-gray-800",children:$.jsxs("div",{className:"container mx-auto px-6",children:[$.jsx("h2",{className:"text-3xl font-bold mb-8",children:"Skills"}),$.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:KS.map((t,e)=>$.jsxs("div",{className:"bg-gray-700 rounded-lg p-6",children:[$.jsx("h3",{className:"text-xl font-semibold mb-4",children:t.name}),$.jsx("ul",{className:"space-y-2",children:t.skills.map((n,i)=>$.jsxs("li",{className:"flex items-center",children:[$.jsx("span",{className:"w-2 h-2 bg-blue-400 rounded-full mr-2"}),$.jsx("span",{children:n})]},i))})]},e))})]})})}function _I(){const[t,e]=Te.useState({}),n=async i=>{if(!i)return null;try{const s=new URL(i).searchParams.get("v");if(!s)return null;const o=`https://img.youtube.com/vi/${s}/maxresdefault.jpg`,a=`https://img.youtube.com/vi/${s}/hqdefault.jpg`;return await(c=>new Promise(d=>{const f=new Image;f.onload=()=>d(!0),f.onerror=()=>{console.error("Image failed to load:",c),d(!1)},f.src=c}))(o)?o:a}catch(r){return console.error("Error getting YouTube thumbnail:",r),null}};return Te.useEffect(()=>{(async()=>{const r={};for(let s=0;s<Go.length;s++){const o=Go[s];if(o.liveDemo){const a=await n(o.liveDemo);r[s]=a}}e(r)})()},[Go]),$.jsx("section",{id:"projects",className:"py-20",children:$.jsxs("div",{className:"container mx-auto px-6",children:[$.jsx("h2",{className:"text-3xl font-bold mb-8",children:"Personal Projects"}),$.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:Go.map((i,r)=>$.jsxs("div",{className:"bg-gray-800 rounded-lg p-6",children:[$.jsx("h3",{className:"text-xl font-semibold mb-2",children:i.title}),$.jsx("p",{className:"text-gray-400 mb-4",children:i.date}),$.jsx("p",{className:"text-gray-300 mb-4",children:i.description}),i.liveDemo&&$.jsx("a",{href:i.liveDemo,target:"_blank",rel:"noopener noreferrer",className:"block mb-4 relative",children:t[r]?$.jsxs($.Fragment,{children:[$.jsx("img",{src:t[r],alt:`${i.title} - YouTube Demo`,className:"rounded-md w-full transition-opacity duration-300",style:{maxWidth:"100%",height:"auto",opacity:1}}),$.jsx("div",{className:"absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white cursor-pointer opacity-60 hover:opacity-80 transition-opacity duration-300 flex items-center justify-center",style:{zIndex:10,backgroundColor:"rgba(0, 0, 0, 255.0)",width:"15%",height:"15%",borderRadius:"5.0rem"},children:$.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"currentColor",className:"bi bi-play-circle-fill",viewBox:"0 0 16 16",style:{fontSize:"3em"},children:$.jsx("path",{d:"M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM6.79 5.093A.5.5 0 0 0 6 5.5v5a.5.5 0 0 0 .79.407l3.5-2.5a.5.5 0 0 0 0-.814l-3.5-2.5z"})})})]}):$.jsx("div",{className:"w-full h-36 bg-gray-700 rounded-md flex items-center justify-center text-gray-500",children:"Loading Thumbnail..."})}),i.image&&!i.liveDemo&&$.jsx("img",{src:i.image,alt:i.title,className:"mb-4 rounded-md",style:{maxWidth:"100%",height:"auto"}}),i.github&&$.jsx("a",{href:i.github,target:"_blank",rel:"noopener noreferrer",className:"text-green-400 hover:text-green-300 transition-colors block",children:"View on GitHub"})]},r))})]})})}function yI(){return $.jsx("section",{id:"education",className:"py-20 bg-gray-800",children:$.jsxs("div",{className:"container mx-auto px-6",children:[$.jsx("h2",{className:"text-3xl font-bold mb-8",children:"Education"}),$.jsx("div",{className:"space-y-6",children:ZS.map((t,e)=>$.jsxs("div",{className:"bg-gray-700 rounded-lg p-6",children:[$.jsx("h3",{className:"text-xl font-semibold mb-2",children:t.degree}),$.jsxs("p",{className:"text-gray-300",children:[t.institution,", ",t.location]}),$.jsx("p",{className:"text-gray-400",children:t.dates}),t.details&&$.jsx("p",{className:"text-gray-300 mt-2",children:t.details}),$.jsx("p",{className:"text-blue-400 mt-2",children:t.grade})]},e))})]})})}function xI(){return $.jsx("section",{id:"contact",className:"py-20",children:$.jsxs("div",{className:"container mx-auto px-6",children:[$.jsx("h2",{className:"text-3xl font-bold mb-8",children:"Contact"}),$.jsxs("div",{className:"flex flex-col items-center space-y-4",children:[$.jsxs("a",{href:`mailto:${br.email}`,className:"flex items-center text-lg hover:text-blue-400 transition-colors",children:[$.jsx(iR,{className:"mr-2"})," ",br.email]}),$.jsxs("a",{href:`tel:${br.phone}`,className:"flex items-center text-lg hover:text-blue-400 transition-colors",children:[$.jsx(rR,{className:"mr-2"})," ",br.phone]}),$.jsxs("a",{href:br.linkedin,target:"_blank",rel:"noopener noreferrer",className:"flex items-center text-lg hover:text-blue-400 transition-colors",children:[$.jsx(nR,{className:"mr-2"})," LinkedIn"]}),$.jsxs("a",{href:br.github,target:"_blank",rel:"noopener noreferrer",className:"flex items-center text-lg hover:text-blue-400 transition-colors",children:[$.jsx(tR,{className:"mr-2"})," GitHub"]}),$.jsxs("p",{className:"text-gray-300 mt-4",children:["Located in ",br.location]})]})]})})}function SI(){const[t,e]=Te.useState("home");return Te.useEffect(()=>{const n=()=>{const r=["home","about","experience","skills","projects","education","contact"].find(s=>{const o=document.getElementById(s);if(o){const a=o.getBoundingClientRect();return a.top<=100&&a.bottom>=100}return!1});r&&e(r)};return window.addEventListener("scroll",n),()=>window.removeEventListener("scroll",n)},[]),$.jsxs("div",{className:"bg-gray-900 text-white min-h-screen",children:[$.jsx("header",{className:"fixed top-0 left-0 right-0 z-50 bg-gray-900 bg-opacity-90 backdrop-blur-sm",children:$.jsx("nav",{className:"container mx-auto px-6 py-4",children:$.jsx("ul",{className:"flex justify-center space-x-6 overflow-x-auto md:overflow-visible",children:["Home","About","Experience","Skills","Projects","Education","Contact"].map(n=>$.jsx("li",{children:$.jsx("a",{href:`#${n.toLowerCase()}`,className:`text-sm font-medium hover:text-blue-400 transition-colors whitespace-nowrap ${t===n.toLowerCase()?"text-blue-400":""}`,children:n})},n))})})}),$.jsxs("main",{className:"pt-16",children:[$.jsx(pI,{}),$.jsx(mI,{aboutData:Hn}),$.jsx(gI,{experienceData:QS}),$.jsx(vI,{skillsData:KS}),$.jsx(_I,{projectsData:Go}),$.jsx(yI,{educationData:ZS}),$.jsx(xI,{})]})]})}function MI(){return $.jsx(SI,{})}Gy(document.getElementById("root")).render($.jsx(Te.StrictMode,{children:$.jsx(MI,{})}));
